...
import {BsFillMicFill, BsListNested} from 'react-icons/bs'
...
const Searchinput = () => {
  ...
  return (  
    <>
        <form onSubmit={handleSubmit} className='flex w-full mt-5 mx-auto max-w-[90%] border border-gray-200 px-5 py-3 rounded-full hover:shadow-md transition-shadow focus:focus-within:shadow-md sm:max-w-xl lg:max-w-2xl'>
